...
```R
selected_gene <- c('CCL23','DUSP5','IL31RA')
```
   ...
   as.data.frame()  %>% 
    rownames_to_column(var = 'Samples')  %>% 
     left_join(pheno_group, by  ='Samples')  %>% 
      as_tibble() %>% 
        select(CCL23,Type,Ages) %>% 
        mutate(Ages = as.integer(Ages)) %>% 
           ggscatter(x = "Ages", y = "CCL23", xlab = 'Ages',size = 0.5, alpha = 0.5,
  ...
  t()  %>% 
   as.data.frame()  %>% 
    rownames_to_column(var = 'Samples')  %>% 
     left_join(pheno_group, by  ='Samples')  %>% 
      as_tibble() %>% 
        select(DUSP5,Type,Ages) %>% 
        mutate(Ages = as.integer(Ages)) %>% 
           ggscatter(x = "Ages", y = "DUSP5", xlab = 'Ages',size = 0.5, alpha = 0.5,
                   add = "reg.line", add.params = list(color = "blue", fill = "lightgray"), conf.int = TRUE ) + stat_cor(method = "pearson",size=2)+ ggh4x::facet_wrap2(~Type, scales = "free", strip = strip) +
         theme(plot.title=element_text(hjust=0.5, size = 8),
            axis.text.x = element_text(hjust=1,size=6),
             axis.text.y = element_text(size=6),
  ...
  t()  %>% 
   as.data.frame()  %>% 
    rownames_to_column(var = 'Samples')  %>% 
     left_join(pheno_group, by  ='Samples')  %>% 
      as_tibble() %>% 
        select(IL31RA,Type,Ages) %>% 
        mutate(Ages = as.integer(Ages)) %>% 
           ggscatter(x = "Ages", y = "IL31RA", xlab = 'Ages',size = 0.5, alpha = 0.5,
                   add = "reg.line", add.params = list(color = "blue", fill = "lightgray"), conf.int = TRUE ) + stat_cor(method = "pearson",size=2)+ ggh4x::facet_wrap2(~Type, scales = "free", strip = strip) +
         theme(plot.title=element_text(hjust=0.5, size = 8),
            axis.text.x = element_text(hjust=1,size=6),
             axis.text.y = element_text(size=6),
...
![png](Step11.9_GSE21545_Correlation_files/Step11.9_GSE21545_Correlation_16_1.png)
...
![png](Step11.9_GSE21545_Correlation_files/Step11.9_GSE21545_Correlation_16_3.png)
    



    
![png](Step11.9_GSE21545_Correlation_files/Step11.9_GSE21545_Correlation_16_4.png)
  ...
  t()  %>% 
   as.data.frame()  %>% 
    rownames_to_column(var = 'Samples')  %>% 
     left_join(pheno_group, by  ='Samples')  %>% 
      as_tibble() %>% 
        select(CCL23,Type,Time) %>% 
        mutate(Time = as.integer(Time)) %>% 
           ggscatter(x = "Time", y = "CCL23", xlab = 'Days',size = 0.5, alpha = 0.5,
  ...
  t()  %>% 
   as.data.frame()  %>% 
    rownames_to_column(var = 'Samples')  %>% 
     left_join(pheno_group, by  ='Samples')  %>% 
      as_tibble() %>% 
        select(DUSP5,Type,Time) %>% 
        mutate(Time = as.integer(Time)) %>% 
           ggscatter(x = "Time", y = "DUSP5", xlab = 'Days',size = 0.5, alpha = 0.5,
                   add = "reg.line", add.params = list(color = "blue", fill = "lightgray"), conf.int = TRUE ) + stat_cor(method = "pearson",size=2,label.x = 800) +
         theme(plot.title=element_text(hjust=0.5, size = 8),
            axis.text.x = element_text(hjust=1,size=6),
             axis.text.y = element_text(size=6),
  ...
  t()  %>% 
   as.data.frame()  %>% 
    rownames_to_column(var = 'Samples')  %>% 
     left_join(pheno_group, by  ='Samples')  %>% 
      as_tibble() %>% 
        select(IL31RA,Type,Time) %>% 
        mutate(Time = as.integer(Time)) %>% 
           ggscatter(x = "Time", y = "IL31RA", xlab = 'Days',size = 0.5, alpha = 0.5,
                   add = "reg.line", add.params = list(color = "blue", fill = "lightgray"), conf.int = TRUE ) + stat_cor(method = "pearson",size=2,label.x = 800) +
         theme(plot.title=element_text(hjust=0.5, size = 8),
            axis.text.x = element_text(hjust=1,size=6),
             axis.text.y = element_text(size=6),
...
![png](Step11.9_GSE21545_Correlation_files/Step11.9_GSE21545_Correlation_18_1.png)
...
![png](Step11.9_GSE21545_Correlation_files/Step11.9_GSE21545_Correlation_18_3.png)
    



    
![png](Step11.9_GSE21545_Correlation_files/Step11.9_GSE21545_Correlation_18_4.png)
